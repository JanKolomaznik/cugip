...
template<typename TElement, int tDim>
unified_image_view<TElement, tDim>
view(const unified_image_view<TElement, tDim> &aView)
{
	return aView;
}
...
template<typename TElement, int tDim>
const_unified_image_view<TElement, tDim>
const_view(const unified_image_view<TElement, tDim> &aView)
{
	return const_unified_image_view<TElement, tDim>(aView.pointer(), aView.dimensions(), aView.strides());
}


template<typename TElement, int tDim>
const_unified_image_view<TElement, tDim>
const_view(const const_unified_image_view<TElement, tDim> &aView)
{
	return aView;
}
